...
#define STARTUP_MODE_PIN  3       // pin for force default setup when low (use 10k pullup to insure high)
#define DIRECTION_PIN     1       // pin for output direction enable on MAX481 chip (pin D4 or D15)
...
void setup() {
  //Serial.begin(115200);
  Serial.setDebugOutput(1); //use uart0 for debugging  UART0 at 74880 baud
